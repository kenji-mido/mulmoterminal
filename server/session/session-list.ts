...
export interface SessionRowFilter {
  /** Transient internal helpers, never user-visible chats: a hidden translation worker, or
   *  a headless `claude -p` run (the AI header title / the Run menu's Explain). Both write a
