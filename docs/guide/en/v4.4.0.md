...
- **Reveal in the file manager** — exactly what clicking the path used to do, kept first
- **Browse files in the app**
- **New terminal here**
- **Repository / Issues / Pull requests** — when the directory resolves to a GitHub URL

And four buttons left the default header set — `reveal`, `files`, `terminal`, `gh` — along with the
