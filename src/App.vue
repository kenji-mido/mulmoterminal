...
<template>
  ...
  <FilesOverlay />
  <!-- App-wide in-browser file picker (a cell's attach-file button). Mounted on the page rather
       than in a view: it replaces the native OS dialog, which would otherwise open on the
       SERVER's screen, and any cell in the grid can raise it as a modal. -->
  <FilePickerHost />
